//https://github.com/axel-zarate/xslt-email
...
namespace AxSoft.TemplateEmail.Net
{
	public class TemplateEmailSender : ITemplateEmailSender
	{
		...
		public void Send(string templatePath, object variables, string to, string cc, string subject)
		{
			var mailMessage = ConstructMailMessage(templatePath, variables, to, cc, subject);

			_emailSender.Send(mailMessage);
		}

		public Task SendAsync(string templatePath, object variables, string to, string cc, string subject)
		{
			var mailMessage = ConstructMailMessage(templatePath, variables, to, cc, subject);
		...
		public MailMessage ConstructMailMessage(string templatePath, object variables, string to, string cc, string subject)
		{
